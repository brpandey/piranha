  ...
  namespace :timeslots do
    ...
    params do
      group :timeslot, type: Map do
        # unix timestamp e.g. 1406052000
        requires(:start_time, type: Integer)
        # 30 mins to 24 hours
        requires(:duration, type: Integer, values: 30..1440)
      end
    end
    ...
    # simple date match YYYY-MM-DD, more complex is ~r/^(19|20)\d\d-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$ 
    params do
